...
test('getDisplayName gets the display name of a React component', function () {
  ...
  expect((0, _getDisplayName2.default)(SomeOtherComponent)).toBe('CustomDisplayName');
  expect((0, _getDisplayName2.default)(YetAnotherComponent)).toBe('YetAnotherComponent');
  expect((0, _getDisplayName2.default)(function () {
    return _react2.default.createElement('div', null);
  })).toBe('Component');
