  ...
  return function (BaseComponent) {
    ...
    var WithState = function (_Component) {
      ...
      function WithState() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WithState.__proto__ || Object.getPrototypeOf(WithState)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _createClass(WithState, [{
        ...
        value: function render() {
          ...
          return factory(Object.assign({}, this.props, (_Object$assign = {}, _defineProperty(_Object$assign, stateName, this.state.stateValue), _defineProperty(_Object$assign, stateUpdaterName, this.updateStateValue), _Object$assign)));
        }
      }]);
